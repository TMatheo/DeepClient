...
namespace DeepCore.Client.API
{
    public static class APIUtils
    {
        ...
        public static Sprite OnIconSprite()
        {
            if (_onSprite == null)
            {
                _onSprite = QuickMenuInstance.transform.Find("CanvasGroup/Container/Window/QMParent/Menu_Notifications/Panel_NoNotifications_Message/Icon").GetComponent<ImageEx>().sprite;
            }
            return _onSprite;
        }
        public static Sprite OffIconSprite()
        {
            if (_offSprite == null)
            {
                _offSprite = QuickMenuInstance.transform.Find("CanvasGroup/Container/Window/QMParent/Menu_Settings/Panel_QM_ScrollRect/Viewport/VerticalLayoutGroup/Buttons_UI_Elements_Row_1/Button_ToggleQMInfo/Icon_Off").GetComponent<ImageEx>().sprite;
            }
            return _offSprite;
        }
